...
$ediscription=$_POST['evetndesrciption'];
...
$sql="INSERT INTO  tblevents(CategoryId,SponserId,EventName,EventDescription,EventStartDate,EventEndDate,EventLocation,EventImage,IsActive,EventPrice) VALUES(:catid,:spnserid,:ename,:ediscription,:esdate,:eedate,:elocation,:eventimage,:status,:eprice)";
...
<textarea class="form-control" type="text" name="eventprice" autocomplete="off" required autofocus></textarea>
</div>
