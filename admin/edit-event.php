...
$sql="UPDATE  tblevents set CategoryId=:catid,SponserId=:spnserid,EventName=:ename,EventPrice= :eprice,EventDescription=:ediscription,EventStartDate=:esdate,EventEndDate=:eedate,EventLocation=:elocation where id=:eid";
...
<input class="form-control" type="text" name="eventprice" autocomplete="off" value="<?php echo htmlentities($result->EventPrice);?>" required >
</div>
